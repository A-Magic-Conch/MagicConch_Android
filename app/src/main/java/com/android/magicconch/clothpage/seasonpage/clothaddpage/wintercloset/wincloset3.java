...
public class wincloset3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wincloset3);

        // SharedPreferences에서 데이터 불러오기
        String[] clothTypes = {"아우터", "상의", "하의", "신발", "악세사리"};
        SharedPreferences sharedPreferences = getSharedPreferences("wincloset3", MODE_PRIVATE);
