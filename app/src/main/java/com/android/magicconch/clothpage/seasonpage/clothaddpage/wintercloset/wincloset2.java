...
public class wincloset2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wincloset2);

        // SharedPreferences에서 데이터 불러오기
        String[] clothTypes = {"아우터", "상의", "하의", "신발", "악세사리"};
        SharedPreferences sharedPreferences = getSharedPreferences("wincloset2", MODE_PRIVATE);
