...
public class sucloset2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sucloset2);

        // SharedPreferences에서 데이터 불러오기
        String[] clothTypes = {"상의", "하의", "신발", "악세사리"};
        SharedPreferences sharedPreferences = getSharedPreferences("sucloset2", MODE_PRIVATE);
