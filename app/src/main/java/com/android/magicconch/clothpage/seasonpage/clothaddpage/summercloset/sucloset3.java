...
public class sucloset3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sucloset3);

        // SharedPreferences에서 데이터 불러오기
        String[] clothTypes = {"상의", "하의", "신발", "악세사리"};
        SharedPreferences sharedPreferences = getSharedPreferences("sucloset3", MODE_PRIVATE);
